...
export function Rooms() {
  ...
  return (
    <>
      ...
      >
        {editing && (
          <form onSubmit={save} className="max-h-[78vh] space-y-4 overflow-y-auto pr-1">
            <label>
